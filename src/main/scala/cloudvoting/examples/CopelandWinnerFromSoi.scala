...
object CopelandWinnerFromSoi {

  /**
    * Calculates the Copeland Winner from a SOI file. Only use PrefLib format as input!
    *
  ...
  def main(args: Array[String]): Unit = {
    ...
    if(args.length == 0){
      ...
      conf.setAppName("CloudVoting Example: CopelandWinnerFromSoi")
